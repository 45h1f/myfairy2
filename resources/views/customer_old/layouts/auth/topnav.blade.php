<div class="jumbotron bg-transparent m-auto w-100">
    ...
    <div class="user float-right d-flex align-items-center position-relative">
        ...
        <div class="position-relative">
            <a class="c-pointer" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <img src="{{asset('/public/assets/admin/images/atikh-bana.png')}}" alt=""></a>
            <div class="dropdown-menu dropdown-menu-nav" aria-labelledby="dropdownMenuButton">
                <a class="dropdown-item" href="#">Action</a>
                <a class="dropdown-item" href="#">Another action</a>
                <a class="dropdown-item" href="#">Something else here</a>
