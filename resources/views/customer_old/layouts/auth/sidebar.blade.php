    ...
    <ul class="sidebar-navigation" id="sidebar-navigation">
        ...
        <li class="item @if(request()->is('admin-panel/products*')) active @endif">
            <a href="{{route('products')}}">
                <i class="fas fa-box link"></i><br>
                <span>Products</span>
            </a>
        </li>
        <li class="item @if(request()->is('admin-panel/services*')) active @endif">
            <a href="{{route('services')}}">
                <i class="fas fa-landmark link"></i><br>
                <span>Services</span>
            </a>
        </li>
        <li class="item position-relative @if(request()->is('admin-panel/reports*')) active @endif">
            <a href="{{route('reports')}}">
                <i class="far fa-clipboard link"></i><br>
                <span>Reports</span>
            </a>
            <svg  class="reports" width="16" height="15" viewBox="0 0 16 15" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M14.9158 5.1668L10.214 4.73072L8.34626 0.393774C8.21548 0.0900962 7.78493 0.0900962 7.65418 0.393774L5.78649 4.73069L1.08469 5.1668C0.755449 5.19731 0.622419 5.60681 0.870796 5.82503L4.41832 8.94147L3.38013 13.5479C3.30742 13.8705 3.65578 14.1235 3.94006 13.9547L8.00022 11.5439L12.0604 13.9547C12.3447 14.1236 12.693 13.8705 12.6203 13.5479L11.5821 8.94147L15.1297 5.82503C15.378 5.60681 15.245 5.19731 14.9158 5.1668Z" fill="#FFDC64"/>
</svg>
        </li>
    </ul>
</div>
