...
{{--    <link rel="stylesheet" type="text/css" href="{{URL::to('storage/app/public/Frontassets/css/toastr.min.css')}}">--}}
...
<!-- custom js -->
{{--<script src="{{URL::to('storage/app/public/Frontassets/js/toastr.min.js')}}"></script>--}}
