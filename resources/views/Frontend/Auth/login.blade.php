    ...
    <div class="container-fluid p-0 h-100">
        <div class="signup-wrap">
            <div class="signup-aside">
                ...
                <div class="signup-img"><img src="{{URL::to('storage/app/public/Frontassets/images/signup-img.svg')}}"
                                             alt=""></div>
            </div>
            <div class="signup-main">
                ...
                <div class="signup-form-wrap">
                    ...
                    <div class="signup-google">
                        <a href="javascript:void(0)" class="google-btn"><i class="fab fa-google"></i> Sign In With
                            Google</a>
