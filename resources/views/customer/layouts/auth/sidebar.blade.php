<div class="sidebar-container" id="side-nav" style="!important; overflow-y: scroll !important;">
    ...
    <ul class="sidebar-navigation" id="sidebar-navigation">
        <li class="item  @if(request()->is('customer')) active @endif">
            <a href="{{route('customer.index')}}" >
                <img src="{{asset('public/assets/icons/overview.svg')}}" alt=""> <br>
                <span>Overview</span>
            </a>
        </li>
        <li class="item @if(request()->is('customer/bookings')) active @endif">
            <a href="{{route('customer.bookings')}}" >
                <img src="{{asset('public/assets/icons/booking.svg')}}" alt=""><br>
                <span>Bookings</span>
            </a>
        </li>
        <li class="item @if(request()->is('customer/connects*')) active @endif">
            <a href="{{route('customer.connects')}}">
                <img src="{{asset('public/assets/icons/connects.svg')}}" alt=""><br>
                <span>Connects</span>
            </a>
        </li>
        <li class="item @if(request()->is('customer/payments*')) active @endif">
            <a href="{{route('customer.payments')}}">
                <img src="{{asset('public/assets/icons/payments.svg')}}" alt=""><br>
                <span>Payments</span>
            </a>
        </li>
        <li class="item @if(request()->is('customer/account*')) active @endif">
        ...
        {{-- <li class="item @if(request()->is('customer/products*')) active @endif">
            <a href="{{route('customer.products')}}">
                <img src="{{asset('public/assets/icons/products.svg')}}" alt=""><br>
                <span>Products</span>
            </a>
        </li>
        <li class="item @if(request()->is('customer/services*')) active @endif">
            <a href="{{route('customer.services')}}">
                <img src="{{asset('public/assets/icons/services.svg')}}" alt=""><br>
                <span>Services</span>
            </a>
        </li>
        <li class="item position-relative @if(request()->is('customer/reports*')) active @endif">
