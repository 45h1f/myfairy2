        ...
        <div class="content-container" id="content-container">
            ...
            <div id="myPayment" class="data payment m-0" style="margin-top: 140px!important;">
                <div class="d-flex align-items-center">
                    <h1>My Cards</h1>
                    <a href="{{route('customer.payment.add')}}" class="btn d-flex align-items-center justify-content-center"><i class="fas fa-plus"></i>New
                        Card</a>
                </div>
                ...
                <div class="row mt-4 mb-5">
                    ...
                    <div class="col-md-6  pr-0">
                        ...
                        <div class="pay new" style="margin-left: 0;width: 100%;">
                            <a href="{{route('customer.payment.add')}}" class="add d-flex align-items-center justify-content-center"><i
